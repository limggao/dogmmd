...
<html>
			...
			<div class="row">
				<form class="xinxi_op">
					<div class="form-group">
						<label class="game">输入QQ号</label>
						<input type="number" class="form-control game_sh" placeholder="请您输入您的QQ号">
					</div>
				</form>
			</div>
			<div class="phone_bill">
				<div class="phone_bill_i">充Q币</div>
				<div class="QB">
				
				</div>
				<!-- <ul class="recharge_shu_04" data-recharge="bill_Q">
					<li>100元</li>
					<li>99</li>
				</ul>
				<ul class="recharge_shu_03" data-recharge="bill_Q">
					<li>300元</li>
					<li>288</li>
				</ul>
				<ul class="recharge_shu_04" data-recharge="bill_Q">
	...
	<script>
		...
		$(function(){
			$.ajax({
				...
				data:{"type":"Q币充值","pageIndex":pageIndex,"pageSize":pageSize},
				success:function(data){
					console.info(data);
		             var datas= eval(data);   
		             var strVar = "";
		             strVar += "<ul class=\"recharge_shu_04\" data-recharge=\"bill_Q\">\n";
		             strVar += "					<li>"+datas[0].facePrice+"元<\/li>\n";
		             strVar += "					<li>"+datas[0].orderCost+"<\/li>\n";
		             strVar += "				<\/ul>\n";
		             strVar += "				<ul class=\"recharge_shu_03\" data-recharge=\"bill_Q\">\n";
	...
	function ss (){
		...
		$(".btn").click(function(){
			phone =$(".game_sh").val();
			console.info(phone);
			 if(phone!=null&&rechargeAmount1!=null&&recharge!=null&&rechargeAmount!=null&&phone!=""&&rechargeAmount1!=""&&rechargeAmount!=""&&recharge!=""){
				window.location.href="payment_method.jsp?mobileNo="+phone+"&rechargeAmount1="+rechargeAmount1+"&recharge="+recharge+"&rechargeAmount="+rechargeAmount+"&openId=<%=ss%>";
				}else{
