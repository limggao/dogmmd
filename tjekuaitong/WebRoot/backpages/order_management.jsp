...
$(function() {       
    InitTable(0);              
    $.ajax({
		url:'/tjekuaitong/OrderDetailInfoController/index',
		data:{"type":value},
    ...
    function InitTable(pageIndex) {                                
        $.ajax({ 
            type: "POST",
            dataType: "json",
            url: '/tjekuaitong/OrderDetailInfoController/userPage',
            ...
            success: function(data) { 
              ...
              for(var i=0;i<datas.length;i++){   
            	  ...
            	  zz += "<tr class='cen_io_g'><td>"+datas[i].userId+"</td><td>"+datas[i].userName+"</td><td>"+datas[i].itemName+"</td><td>"+datas[i].orderCost+"</td><td>"+datas[i].orderTime+"</td><td class='chr_zh'><a>删除</a></td></tr>";
              }
              console.info(zz);
              $(".ss").html(zz);
              // 
        ...
        function InitTable(pageIndex) {                                
            $.ajax({ 
                ...
                success: function(data) { 
                  ...
                  for(var i=0;i<datas.length;i++){   
                	  console.info(datas[i]);
                	  zz += "<tr class='cen_io_g'><td>"+datas[i].userCode+"</td><td>"+datas[i].userName+"</td><td>"+datas[i].itemName+"</td><td>"+datas[i].orderCost+"</td><td>"+datas[i].orderTime+"</td><td class='chr_zh'><a>删除</a></td></tr>";
                  }
                  console.info(zz);
                  $(".ss").html(zz);
                }
